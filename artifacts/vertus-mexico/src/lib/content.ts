...
export const CONTENT: Record<Lang, Content> = {
  es: {
    ...
    nav: [
      ...
      { label: "Por qué Vertus", href: "#capital" },
      { label: "Establecidos en México", href: "#mexico" },
  ...
  en: {
    ...
    nav: [
      ...
      { label: "Why Vertus", href: "#capital" },
      { label: "Established in Mexico", href: "#mexico" },
      { label: "For founders", href: "#fundadores" },
      { label: "Our approach", href: "#enfoque" },
    ],
